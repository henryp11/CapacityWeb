  ...
  return (
    <>
      <section className='prices'>
        ...
        <main className='detSectionMain detSectionMain-cont article'>
          ...
          <div className='article-det'>
            <p style={{ fontSize: '0.9em' }}>
              ...
              mismo sistema contable, tenemos varias versiones especialmente
              diseñadas para satisfacer todas tus necesidades de gestión
              operativa.
              <br />
              <br />
              Estas versiones trabajan 100% en la nube, dándote la flexibilidad
              de poder conectarte desde cualquier lugar en cualquier momento.
              <br />
              <br />
              Poseen la caracteristica de poder manejar varias empresas desde un
              sitio de acceso unificado.
              <br />
              <br />
              Pagas únicamente por los módulos que utilizas, sin limitación
              alguna en el número de documentos que puedes generar
              electrónicamente.
              <br />
              <br />

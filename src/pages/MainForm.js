...
import QrCode from '../images/QR_Contacts.jpg';
import QrIgCode from '../images/QR_IG.jpeg';
      ...
      <article className='contact'>
        <div className='contact_det'>
          ...
          <div className='contact_det_data'>
            ...
            <div className='social_menu social_contact'>
              <a
                href='https://www.instagram.com/capacitysoft?igsh=ZDVyMzJtY3lleG1y'
                target='_blank'
                rel='noreferrer'
                style={{ height: '90%' }}
              >
              ...
              <a
                href='https://www.facebook.com/people/Capacity-Ecu/100009140571790/'
                target='_blank'
                rel='noreferrer'
                style={{ height: '90%' }}
              >
